...
namespace DtCms.DAL
{
	...
	public class Products
	{
		...
		public DataSet GetList(string strWhere)
		{
            ...
            strSql.Append(" Id,Title,ClassId,Guige,Xinghao,Price,Content,Click,IsMsg,IsTop,IsRed,IsHot,IsSlide,IsLock,AddTime,Switch(InStr(ImgUrl,' ')>0,MID(ImgUrl,1,InStr(ImgUrl,' ')),InStr(ImgUrl,' ')=0,ImgUrl) AS ImgUrl ");
            strSql.Append(" FROM Products ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
        ...
        public DataSet GetPageList(int pageSize, int currentPage, string strWhere, string filedOrder)
        {
            ...
            if (currentPage > 0)
            {
                ...
                strSql.Append("select top " + pageSize + " Id,Title,ClassId,Guige,Xinghao,Price,Content,Click,IsMsg,IsTop,IsRed,IsHot,IsSlide,IsLock,AddTime,Switch(InStr(ImgUrl,' ')>0,MID(ImgUrl,1,InStr(ImgUrl,' ')),InStr(ImgUrl,' ')=0,ImgUrl) AS ImgUrl from Products");
