    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtWebPath" runat="server" CssClass="input required" size="25" MaxLength="20"
                        HintTitle="网站的虚拟目录" HintInfo="请填写网站的虚拟目录名称，如果放在根目录下，输入“/”；如：http://abc.com/web，输入“web”。"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td>
                    <asp:TextBox ID="txtWebLogPath" runat="server" CssClass="input required" size="25"
                        MaxLength="20" HintTitle="网站的日志目录" HintInfo="请输入目录存在的物理路径，如“：D:\LogFile\”，且该目录必须开放对网站用户可写权限，否则产生错误。为了系统的安全，请不要将该目录存放在网站下面。"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtQQ1" runat="server" CssClass="input" size="25" MaxLength="50"
                        HintTitle="QQ客服1" HintInfo="纯数字，作为前台右侧栏QQ客服显示"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td>
                    <asp:TextBox ID="txtQQ2" runat="server" CssClass="input" size="25" MaxLength="50"
                        HintTitle="QQ客服2" HintInfo="纯数字，作为前台右侧栏QQ客服显示"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td>
                    <asp:TextBox ID="txtQQ3" runat="server" CssClass="input" size="25" MaxLength="50"
                        HintTitle="QQ客服3" HintInfo="纯数字，作为前台右侧栏QQ客服显示"></asp:TextBox>
                </td>
            </tr>
        </tbody>
    </table>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        <tbody>
            ...
            <tr>
                ...
                <td width="75%">
                    <asp:TextBox ID="txtWebProSize" runat="server" CssClass="input required digits" HintTitle="产品每页显示数量"
                        HintInfo="纯数字，网站前台产品每页显示的数量。" MaxLength="9" size="3"></asp:TextBox>
                    &nbsp;条
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtWebNewsSize" runat="server" CssClass="input required digits"
                        HintTitle="新闻每页显示数量" HintInfo="纯数字，网站前台新闻每页显示的数量。" MaxLength="9" size="3"></asp:TextBox>
                    &nbsp;条
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <asp:RadioButtonList ID="rblWebLogStatus" runat="server" RepeatDirection="Horizontal"
                        RepeatLayout="Flow">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtWebKillKeywords" runat="server" CssClass="textarea" Style="width: 300px;
                        height: 45px;" MaxLength="255" HintTitle="脏话过滤" HintInfo="以“|”号分开，如：我操|我日|妈比，设置后对网站内容进行过滤。"
                        TextMode="MultiLine"></asp:TextBox>
                </td>
            </tr>
        </tbody>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" class="msgtable">
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <asp:RadioButtonList ID="rblIsThumbnail" runat="server" RepeatDirection="Horizontal"
                        RepeatLayout="Flow">
            ...
            <tr>
                ...
                <td>
                    宽：<asp:TextBox ID="txtProWidth" CssClass="input required digits" size="2" runat="server"
                        MaxLength="9"></asp:TextBox>
                    &nbsp;高：<asp:TextBox ID="txtProHight" CssClass="input required digits" size="2" runat="server"
                        MaxLength="9"></asp:TextBox>
                    &nbsp;（单位：像素）
                </td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:RadioButtonList ID="rblWatermarkStatus" runat="server" RepeatDirection="Horizontal"
                        RepeatLayout="Flow">
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="txtImgQuality" CssClass="input required digits" size="2" runat="server"
                        MaxLength="9" HintTitle="上传图片生成的质量" HintInfo="整数，取值范围 0-100，0质量最低，100质量最高，默认80"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td>
                    <asp:TextBox ID="txtImgWaterPath" runat="server" CssClass="input required" size="50"
                        MaxLength="255" HintTitle="图片型水印文件路径" HintInfo="必须为网站根目录下的PNG图片文件，默认为：watermark.png"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td>
                    <asp:TextBox ID="txtImgWaterTransparency" CssClass="input required digits" size="2"
                        runat="server" MaxLength="9" HintTitle="图片水印的透明度" HintInfo="整数，取值范围1--10 (10为不透明)"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td>
                    <asp:TextBox ID="txtWaterText" runat="server" CssClass="input" size="50" MaxLength="250"
                        HintTitle="文字水印内容" HintInfo="可输入中英文，字符长度250以内，如“本图片出自xxx”。"></asp:TextBox>
                </td>
            </tr>
            <tr>
                <td align="right">
                ...
                <td>
                    字体：<asp:DropDownList ID="ddlWaterFont" runat="server">
                    ...
                    &nbsp;大小：<asp:TextBox ID="txtFontSize" CssClass="input required digits" size="2"
                        runat="server" MaxLength="9"></asp:TextBox>（单位：像素）
                </td>
            </tr>
        </tbody>
    </table>
