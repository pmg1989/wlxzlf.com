...
<tbody>
    ...
    <td height="70" colspan="3" style="background:url(images/head_bg.gif);"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <!--导航菜单,与下面的相关联,修改时注意参数-->
          ...
          <ul>
			...
			<li onclick="tabs(2);"><a href="Products/List.aspx" target="sysMain"><span>产品管理</span></a></li>
			<li onclick="tabs(3);"><a href="Contents/List.aspx" target="sysMain"><span>内容管理</span></a></li>
			<li onclick="tabs(4);"><a href="Feedback/List.aspx" target="sysMain"><span>互动管理</span></a></li>
  ...
  <tr>
    ...
    <div style="float:right;line-height:20px;">
        <asp:LinkButton 
            ID="LinkBtnFabu" runat="server" onclick="LinkBtnFabu_Click">发布网站</asp:LinkButton> |
        <a href="admin_center.aspx" target="sysMain">管理中心</a> | 
    ...
    <td align="middle" id="mainLeft" valign="top" style="background:#FFF;">
	  <div style="text-align:left;width:185px;height:100%;font-size:12px;">
        ...
        <div class="left_menu">
          ...
          <ul>
            <li><a href="Channel/Add.aspx?kindId=1" target="sysMain">增加类别</a></li>
            <li><a href="Channel/List.aspx?kindId=1" target="sysMain">类别管理</a></li>
          </ul>
        </div>
        
        <div class="left_menu">
          <ul>
            <li><a href="Products/Add.aspx" target="sysMain">发布产品</a></li>
            <li><a href="Products/List.aspx" target="sysMain">产品管理</a></li>
          </ul>
          <ul>
