<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BarAdd.aspx.cs" Inherits="DtCms.Web.Admin.Advertising.BarAdd" %>
...
<form id="form1" runat="server">
    <div class="navigation">
      <span class="back"><a href="BarList.aspx?Pid=<%=pid %>">返回列表</a></span><b>您当前的位置：管理中心 &gt; 系统管理 &gt; 增加广告</b>
    </div>
