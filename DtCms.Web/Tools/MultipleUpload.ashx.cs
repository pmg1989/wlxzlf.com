...
namespace DtCms.Web.Tools
{
    ...
    public class MultipleUpload : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            int i = int.Parse(context.Request.QueryString["index"]);
            HttpFileCollection _upfiles = context.Request.Files;
            HttpPostedFile _upfile = _upfiles.Get(i);
            string _delfile = context.Request.Params["txtImgUrl" + i];
            if (_upfile == null)
            {
