<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="productdetail.aspx.cs" Inherits="DtCms.Web.m.productdetail" %>
    ...
    <div class="box_info">
      <div class="box_display">
          ...
          <div class="display_content">
              ...
              <p>
                  <b>价格：</b><asp:Label ID="lbprice" runat="server" Text=""></asp:Label>
              </p>
              <p>
