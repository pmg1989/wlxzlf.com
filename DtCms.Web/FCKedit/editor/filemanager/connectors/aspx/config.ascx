...
//    private bool m_isAuthenticated;
	...
	private bool CheckAuthentication()
	{
        ...
        return (Session["AdminName"] != null && Session["AdminNo"] != null);
	}
	...
	public override void SetConfig()
	{
        ...
        DtCms.Model.WebSet model = new DtCms.BLL.WebSet().loadConfig(Server.MapPath(ConfigurationManager.AppSettings["Configpath"].ToString()));
        //UserFilesPath = "~/" + ConfigurationManager.AppSettings["webFilePath"].ToString();
        UserFilesPath = "~/" + model.WebFilePath.ToString();
